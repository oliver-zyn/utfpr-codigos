 ...
 * @author Geri
 */
public class CadastroPalestrante extends javax.swing.JDialog {
// vetor din?mico para clientes
    PalestranteDAO con = new PalestranteDAO(); 
    List<Palestrante> palestrante = new ArrayList();
    Palestrante paletaux;
    ...
    /**
     * Creates new form CadastroPalestrante
     * @param parent
     * @param modal
     */
    public CadastroPalestrante(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        // informa como devem estar os bot?es no in?cio do processo
        ativaInicio();
        palestrante = con.listar();
    ...
    private void initComponents() {
        ...
        setTitle("Cadastrar Palestrante");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Dados do Palestrante"));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tfAreaAtuacao, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        paletaux = new Palestrante(nome, descricao, areaAtuacao);
        // adicionando o objeto ao vetor din?mico de clientes
        if (novo) {
            con.inserir(paletaux);
            palestrante.add(paletaux);
            i = palestrante.size() - 1;
        } else {
            // altera os dados da posi??o armazenada em i
            con.alterar(paletaux);
            palestrante.set(i, paletaux);
        }
        novo = false;
        ativaNavegacao();
    ...
    private void btProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProximoActionPerformed
        ...
        if ((!palestrante.isEmpty()) && (i < palestrante.size() - 1)) {
    ...
    private void btUltimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btUltimoActionPerformed
        // TODO add your handling code here:
        if ((!palestrante.isEmpty()) && (i < palestrante.size() - 1)) {
            i = palestrante.size() - 1; // vai para o ?ltimo registro
            carregaDados();
        } else {
            JOptionPane.showMessageDialog(this, "J? est? no ?ltimo registro");
        }
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        if (i >= 0) {
            ...
            con.remover(palestrante.get(i).getId());
            palestrante.remove(i);
    ...
    private void carregaDados() {
        ...
        // armazenado em i
        paletaux = palestrante.get(i); // recupera o cliente armazenado em i
        tfNome.setText(paletaux.getNome());
        txtDescricao.setText(paletaux.getDescricao());
        tfAreaAtuacao.setText(paletaux.getAreaAtuacao());
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                CadastroPalestrante dialog = new CadastroPalestrante(new javax.swing.JFrame(), true);
