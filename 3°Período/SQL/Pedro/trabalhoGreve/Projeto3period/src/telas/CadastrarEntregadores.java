...
import util.EntregadoresDAO;

/**
 *
 * @author Geri
 */
public class CadastrarEntregadores extends javax.swing.JDialog {

    EntregadoresDAO con = new EntregadoresDAO(); 
    List<Entregadores> entregadores = new ArrayList();
    Entregadores entregadoresAux;
    
    boolean novo = false;
    int i = -1;
    
    public CadastrarEntregadores(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        // informa como devem estar os bot?es no in?cio do processo
        ativaInicio();
        entregadores = con.listar();
    ...
    private void initComponents() {
        ...
        tfUserID = new javax.swing.JSpinner();
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        int user_id = ((Number) tfUserID.getValue()).intValue();
        String nome = tfNome.getText();
        String telefone = tfTelefone.getText();
        
        entregadoresAux = new Entregadores(user_id, cpf, nome, telefone);
        
        if (novo) {
            con.inserir(entregadoresAux);
            entregadores.add(entregadoresAux);
            i = entregadores.size() - 1;
        } else {
            con.alterar(entregadoresAux);
            entregadores.set(i, entregadoresAux);
        }
        novo = false;
        ativaNavegacao();
    ...
    private void btProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProximoActionPerformed
        ...
        if ((!entregadores.isEmpty()) && (i < entregadores.size() - 1)) {
    ...
    private void btUltimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btUltimoActionPerformed
        // TODO add your handling code here:
        if ((!entregadores.isEmpty()) && (i < entregadores.size() - 1)) {
            i = entregadores.size() - 1; // vai para o ?ltimo registro
            carregaDados();
        } else {
            JOptionPane.showMessageDialog(this, "Ja esta no ultimo registro");
        }
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        if (i >= 0) {
            ...
            con.remover(entregadores.get(i).getEntregador_id());
    ...
    private void carregaDados() {
        ...
        // armazenado em i
        entregadoresAux = entregadores.get(i); // recupera o cliente armazenado em i
        tfCPF.setText(entregadoresAux.getCPF());
        tfUserID.setValue(entregadoresAux.getUsuario_id());
        tfNome.setText(entregadoresAux.getNome());
        tfTelefone.setText(entregadoresAux.getTelefone());
    }
    ...
    private javax.swing.JSpinner tfUserID;
