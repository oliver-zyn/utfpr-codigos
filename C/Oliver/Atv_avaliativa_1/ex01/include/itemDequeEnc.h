...
void insereFinal_Deque(Deque* dq, int chave, int ano_publicacao, char manchete[], char corpo[], char autor[], char classificacao[]);
void insereInicio_Deque(Deque* dq, int chave, int ano_publicacao, char manchete[], char corpo[], char autor[], char classificacao[]);
